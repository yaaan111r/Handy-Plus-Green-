...
6. **מתן הצעת מחיר:** לאחר אישור השירות והגדרת הכתובת/הדחיפות (יש לשאול פעם אחת בלבד על כתובת ודחיפות) - תן מחיר משוער מהמחירון המתחשב בכמות היחידות שנדרש לבצע (חובה לרשום שזה עבור עבודה בלבד) + הפניה למספר 055-9821845.
